...
$(function() {
    ...
    */
    ...
    describe("The menu", function() {
        ...
        var menuElement, parentClass;
        beforeEach( function() {
            menuElement = document.querySelector('.slide-menu');
            parentClass = menuElement.parentElement.classList;
        });
        ...
        it('menu element is hidden', function(){
            expect(parentClass[0]).toBe('menu-hidden');
        });
        ...
        it('menu changes visibility through menu icon', function() {
            ...
            expect(parentClass[0]).not.toBeDefined();
            $('body').toggleClass('menu-hidden');
            expect(parentClass[0]).toBe("menu-hidden");
        });
    ...
    describe("New Feed Selection", function() {
        ...
        beforeEach( function(done) {
            dataId = Math.floor(Math.random()*4);
            loadFeed(dataId, function() {
                done();
            });
            currentFeeds = document.querySelector('.feed').innerHTML;
            loadFeed((dataId+1)%4, function() {
                done();
            });
        });
